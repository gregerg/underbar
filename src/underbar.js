...
(function() {
  ...
  _.reject = function(collection, test) {
    ...
    var rejectTest = function(x) { return !test(x); };
  ...
  _.map = function(collection, iterator) {
    ...
    var output = [];
    collection.forEach(function(value, index, collection) {
      output.push(iterator(value,index,collection));
    });
    return output;
  };
  ...
  _.memoize = function(func) {
    ...
    return function() {
      ...
      if (key in out) {
        ...
        out[key] = func.apply(this, arguments);
        return out[key];
      }
    }
  };
  ...
  _.shuffle = function(array) {
    ...
    array.forEach(function(value, index) {
      num = Math.floor(Math.random() * (index + 1));
